...
export const PRODUCT_TOP_RATE_REQUEST = 'PRODUCT_TOP_RATE_REQUEST';
export const PRODUCT_TOP_RATE_SUCCESS = 'PRODUCT_TOP_RATE_SUCCESS';
export const PRODUCT_TOP_RATE_FAIL = 'PRODUCT_TOP_RATE_FAIL';
